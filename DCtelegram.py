...
TOKEN = "6305574539:AAHfmQgQeSEf6d0c52B9MmhgjpujE1aMMJA"
...
def send_quote(message):
    ...
    if quote_text and author:
        ...
        big_gothic_font = ImageFont.truetype("GOTHIC.TTF", big_font_size)  # Bold Gothic font
        ...
        bot.send_message(message.chat.id, "Failed to fetch a quote.")
