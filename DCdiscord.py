...
async def quote(ctx):
    ...
    if quote_text and author:
        ...
        with open(temp_image_path, "rb") as image_file:
            await ctx.send(file=discord.File(image_file, filename="quote_image.png"))

    else:
        await ctx.send("Failed to fetch a quote.")

# Run the bot
bot.run("MTEzNjI0Nzc5NTE1MDUwNDA0OA.G9DbuJ.e4uzV4WFnbCEPRC1R5iTg9HQJx60lQ1bwDJ7Kw")
